...
/**
 * Jersey REST client generated for REST resource:MeteoItemRESTResource<br>
 * USAGE:
 * <pre>
 *        MeteoREST client = new MeteoREST();
...
public class MeteoREST {
    ...
    public MeteoREST(String address) {
        client = javax.ws.rs.client.ClientBuilder.newClient();
        String resourcePath = java.text.MessageFormat.format("mItemREST/{0}", new Object[]{address});
